                    ...
                    <div className="mb-4 md:mb-0 pt-40">
                        ...
                        <div className="space-y-4 text-white py-2">
                            ...
                            <div className="flex space-x-4">
                                <a className="text-white hover:text-white transform hover:scale-150 transition-all duration-150 ease-in-out" href="">
                                    <FaGithub />
                                </a>
                                <a className="text-white hover:text-white transform hover:scale-150 transition-all duration-150 ease-in-out" href="">
                                    <FaLinkedinIn />
                ...
                <div>
                    <div className="h-full flex flex-col items-center justify-center mb-5">
                        ...
                        >
                            ...
                            <button
                                type="Submit"
                                className="bg-gray-900 px-8 py-2 rounded-full text-white absolute top-0 right-0 hover:bg-white hover:text-gray-900"
                            >
                                Submit
                            </button>
                        </form>
