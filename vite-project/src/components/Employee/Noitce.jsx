...
const Notice = () => {
  ...
  return (
    <div className="py-20 w-full notice-background font-titillium">
      <h1 className="text-black text-4xl text-center pt-5 py-2 rounded-lg">
        NOTICE BOARD
      </h1>
      <div className="w-full flex flex-col items-center">
        {/* Container with fixed height and overflow hidden */}
        <div className="notice-list-container w-7/12 max-h-80 overflow-hidden">
          {/* Wrapper with scrolling animation */}
