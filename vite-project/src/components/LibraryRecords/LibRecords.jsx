...
const BookSearch = () => {
  ...
  return (
    <div className="font-titillium">
      <h1 className="font-bold py-4 px-4 font-titillium text-4xl flex justify-center">
        Library Book Search
      </h1>
      <input
        type="text"
      ...
      <div className="flex justify-center">
        <button
          ...
          className="px-6 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-600 flex justify-center"
        >
          Search
        </button>
      </div>
